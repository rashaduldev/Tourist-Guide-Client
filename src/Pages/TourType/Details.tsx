  ...
  return (
    <div className="group flex h-full flex-col overflow-hidden rounded-2xl border border-border bg-card shadow-sm transition-all duration-300 hover:-translate-y-1.5 hover:shadow-xl dark:border-border dark:bg-card">
      <div className="relative h-52 overflow-hidden">
        ...
        />
        <span className="absolute right-3 top-3 rounded-full bg-card/90 px-3 py-1 text-sm font-bold text-primary backdrop-blur dark:bg-card/80">
          ৳{price}
        </span>
      </div>
      <div className="flex flex-grow flex-col p-5">
        ...
        <p className="mt-2 line-clamp-2 flex-grow text-sm text-muted-foreground dark:text-muted-foreground">
