...
const Needhelp = () => {
    return (
        ...
        <div className='md:max-w-[85rem] container mx-auto my-10'>
            <h1 className='text-3xl md:text-4xl font-bold text-black/90 text-center'>Need any help?</h1>
            <div className='flex flex-col lg:flex-row-reverse justify-center items-center gap-48 my-16'>
                <div className="border border-slate-100 p-5 md:p-14">
