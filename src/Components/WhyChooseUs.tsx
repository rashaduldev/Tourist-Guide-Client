...
export default function WhyChooseUs() {
  const features = [
    ...
    },
    {
      ...
      description: "হোটেল, খাবার ও ট্রান্সপোর্ট সব কিছুতেই আমরা নিশ্চিত করি প্রিমিয়াম মানের সেবা।",
      bg: "bg-green-500",
    },
    {
    ...
    },
    {
      ...
      title: "নিরাপত্তা",
      description: "সেফটি ফার্স্ট – আমরা যাত্রীদের নিরাপত্তাকে সর্বোচ্চ অগ্রাধিকার দিয়ে থাকি।",
      bg: "bg-red-500",
    },
  ];
