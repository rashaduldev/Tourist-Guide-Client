...
<div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
  ...
  <div className="">
   ...
   <div className="grid sm:flex sm:items-center gap-y-3 gap-x-4 shadow-2xl cursor-pointer rounded-md">
      <img className="rounded-full w-20 h-20" src={image} alt="Image Description"/>

      <div className="sm:flex sm:flex-col sm:h-full">
        <div>
          <h3 className="font-medium text-white dark:text-gray-200 text-3xl">
            {name}
          </h3>
        ...
        <div className="mt-2 sm:mt-auto space-x-2.5">
          <a className="inline-flex justify-center items-center text-white rounded-full hover:text-gray-800 dark:hover:text-gray-200 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="#">
