...
const toursData = [
  {
    ...
    description: "বাংলাদেশের সবচেয়ে বড় ম্যানগ্রোভ ফরেস্ট সুন্দরবনে বন্যপ্রাণী ও প্রকৃতির অভিজ্ঞতা।",
    author: {
      name: "আব্দুল করিম",
  ...
  {
    id: "2",
    title: "চট্টগ্রাম পাহাড়ি টুর",
    description: "চট্টগ্রামের পাহাড়ি অঞ্চলে এক অনন্য অভিজ্ঞতা ও ঐতিহ্যবাহী গ্রাম পরিদর্শন।",
    author: {
      name: "মাহমুদা খাতুন",
